...
function createCopyright() {
    ...
    ctx.textAlign = 'end';
    ctx.fillText('SmartPack', canvas.width - 30, 30);        
    ctx.beginPath();
...
document.getElementById('renderBox').addEventListener('click', () => {
    ...
    box.params.length = length;
    box.params.depth = depth;
    createBoxElements();
    updatePanelsTransform();
});
window.updateBoxDimensions = function(length, width, depth) {
    ...
    document.getElementById('input-depth').value = depth;
